...
exports.localFileUpload = async (req, res) => {
    try {
        ...
        //fetch file  from the request body
...
exports.imageUpload = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(imageFile, "project");
...
exports.videoUpload = async (req, res) => {
    try {
        ...
        console.log("uploading to project");
        const response = await uploadFileToCloudinary(videoFile, "project");
        console.log(response);
...
exports.imageReducer = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(imageFile, "project", 50);
        console.log(response);
